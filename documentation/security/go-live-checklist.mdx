...
<Checkbox> Organizasyonunuzun **plan ve kotaları** beklenen işlem hacmini karşılıyor. </Checkbox>
...
<Checkbox> **Hosted Checkout** kullanıyorsanız, `success_url` ve `cancel_url` HTTPS'tir. </Checkbox>
