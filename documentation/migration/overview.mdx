...
| `callbackUrl` (3DS) | `success_url` + `fail_url` (`/payments/3d/init` body'sinde) | Payven banka callback'ini kendisi karşılar; siz yalnızca sonuç yönlendirme URL'lerini verirsiniz |
