...
| Settlement | `GET /settlements`, `POST /settlements`, `GET /settlements/export`, `GET /settlements/{id}/carry-items` | Bearer |
| Parçalı hakediş | `GET /split-settlements`, `GET /split-settlements/{id}`, `GET /split-settlements/{id}/carry-items` | Bearer |
