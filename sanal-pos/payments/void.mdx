...
```json
{
  ...
  "status":         "canceled",
  "extra_properties": {
    "processed_at":            "2026-05-03T16:00:01.234+03:00",
...
<Note>
İptalin ayrı bir kaydı yoktur — iptal, ödemenin **kendi** kaydını `canceled` durumuna çeker. Bu yüzden yanıttaki `transaction_id` hem ödemenin hem de iptalin Payven tarafındaki kimliğidir; iade akışındaki `extra_properties.refund_id` gibi ayrı bir alan gerekmez.
</Note>
