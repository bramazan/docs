...
```json
{
  "sent": [
    ...
    },
    {
      "id":           "9f3d2b8e-...",
      "status":       "completed",
      "sent_date":    "2026-05-03T12:34:58.500+03:00",
      "processed_date":"2026-05-03T12:34:59.234+03:00",
...
|---|---|
| `transfer.completed` | Transfer başarıyla tamamlandı (`completed`) |
| `transfer.delivered` | Banka asenkron kabul etti (FAST ara durumu) |
