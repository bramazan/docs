...
<CardGroup cols={2}>
  ...
  <Card title="Tenant İzolasyonu" icon="shield-keyhole">
    Her organizasyonun verisi diğer organizasyonlardan tamamen yalıtılmıştır.
  </Card>
</CardGroup>
...
Oluşturma/onay/red adımları webhook yayınlamaz — operatör eylemleri konsol audit log'una düşer.
